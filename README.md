...
2. The site is static HTML/CSS/JS and requires no build step.

What's included

- `index.html`, `women.html`, `men.html`, `about.html`
- `css/styles.css` — responsive styles
- `js/script.js` — mobile nav, gallery filters, smooth scroll
- `PITCH.md` — business pitch to the boutique owner

Next steps

- Replace placeholder images with store photography (use `images/` folder).
